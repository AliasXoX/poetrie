{
  ...
  nokogiri = {
    ...
    version = "1.18.10-x86_64-linux-gnu";
  };
  ostruct = {
    groups = ["default"];
    platforms = [];
  ...
  sqlite3 = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "B1W0WPVQHonA1aAAOvxP3W/QWesfsUJCIVMpFwltpL4=";
      type = "gem";
    };
    version = "2.7.4-x86_64-linux-gnu";
  };
  sshkit = {
  ...
  thruster = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "qXmj5JPBEZQHI8CMO3s7b5XF1Eryb+Zbbtrh+W/A3to=";
      type = "gem";
    };
    version = "0.1.15-x86_64-linux";
  };
  timeout = {
    groups = ["default"];
    platforms = [];
